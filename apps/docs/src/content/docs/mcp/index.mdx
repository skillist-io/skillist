...
<DocAlert title="Endpoint" client:load>
  `https://api.skillist.dev/mcp` — streamable HTTP with optional OAuth via Better Auth.
</DocAlert>
...
- [OAuth authentication](/mcp/oauth/) — Better Auth MCP for OAuth-capable clients
