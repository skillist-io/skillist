...
Same paths work on `api.skillist.dev`. Requires session auth or API key. See [API docs](https://api.skillist.dev/docs) for request body and streaming responses.
