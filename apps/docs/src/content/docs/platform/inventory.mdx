...
Run a scan from CI after detecting skill folders in a monorepo, then POST results to the inventory API with an org API key. The web UI includes a **Load example** payload to test the flow.
