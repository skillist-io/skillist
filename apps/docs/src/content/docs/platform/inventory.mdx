...
<DocAlert title="Requires sign-in" client:load>
  Inventory is available at [skillist.io/inventory](https://skillist.io/inventory) for authenticated org members. API routes live under `/v1/orgs/{orgId}/inventory`.
</DocAlert>
