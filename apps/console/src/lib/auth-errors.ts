const AUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  email_not_found:
    "We couldn't read an email from your GitHub account. Make sure your GitHub email is public, or sign in with your email instead.",
  account_not_linked:
    "This account is already linked to another sign-in method. Use the original provider, or sign in with your email.",
...
export function authErrorMessage(code: string | undefined, fallback?: string) {
  ...
  return (
    ...
    fallback ??
    "Sign-in failed. Try again, or sign in with your email."
  );
}
